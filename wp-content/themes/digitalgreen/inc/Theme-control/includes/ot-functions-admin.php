          ...
          array(
            ...
            'pages'               => array( 
              array(
                ...
                'page_title'      => apply_filters( 'ot_theme_options_page_title', __( 'DigitalGreen Admin', 'option-tree' ) ),
                'menu_title'      => apply_filters( 'ot_theme_options_menu_title', __( 'DigitalGreen Admin', 'option-tree' ) ),
                ...
                'position'        => apply_filters( 'ot_theme_options_position',  __( '3', 'option-tree' ) ),
