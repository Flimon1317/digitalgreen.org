...
<?php $news_short_desc = get_post_meta(get_the_ID(),'news_short_desc', true); ?>
<?php $news_by = get_post_meta(get_the_ID(),'news_by', true); ?>
<?php $news_blog_image = get_post_meta(get_the_ID(),'news_blog_image', true); ?>
        ...
        <div class="container">
            <div class="row">
                <div class="news-single text-center">
                    ...
                    <span class="author-name">By: <?php echo $news_by; ?></span>
                ...
                <div class="banner-img">
                    <figure>
                        <img src="<?php echo $news_blog_image; ?>" alt="news"/>
    ...
    <div class="gray-boxes-container section-margin">
        <div class="container news-container">
             <div class="title-header news-title-header text-left">
                <h1 class="dg-header-1 main-section-title ">Related News
