<?php /* Template name: Solutions Coco  */ ?>
<?php 
/**
                            ...
                            <div class="col-sm-6 col-sm-push-6 coco-mobile-img">
                                ...
                                <div class="solution-coco col-sm-6 col-sm-pull-6 coco-mobile-content">
                                    <div class="what-coco-content">
                                        ...
                                        <p>
                                       <a href="<?php echo get_field('solutions_coco_what_is_coco_link'); ?>" class="green-bordered-button learn-more" target="_blank">Explore Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="clearfix coco-about-blocks">
                                ...
                                <div class="col-sm-5 col-sm-offset-1 coco-mobile-content">
                                    <div class="single-mobile-text-content">
                                        ...
                                        <p>
                                        <a href="<?php echo get_field('solutions_coco_how_is_coco_link'); ?>" class="green-bordered-button learn-more" target="_blank">Explore Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $i=1;
                            ...
                            <div class="single-activity-details solution-coco-array">
                                    <div class="image-green-shadow">
                                    ...
                                    <div class="our-solution-block">
                                        ...
                                        <p class="dg-header-5 text-details"><?php echo get_sub_field('solutions_coco_solutions_description'); ?> </p>
                                         <a href="<?php echo get_sub_field('solutions_coco_solutions_link'); ?>" class="solution-coco-array green-bordered-button learn-more">Learn more</a>
                                    </div>
                                </div>
                            </div>
<?php $i++; } ?> 
