                            ...
                            <div class="col-sm-3 <?php if($i==4) echo 'col-xs-12';?> activity-blocks">
                                <div class="single-activity-details solution-coco-array">
                                    ...
                                    <div class="our-solution-block">
                                        <h2 class="dg-header-4 solution-coco-array fontsize-20-title"><span class="hidden-sm hidden-md hidden-lg mobile-half-squre-before-title"></span> 
                                        ...
                                        <p class="dg-header-5 text-details"><?php echo $section['solutionscoco_array_description']; ?> </p>
                                         <a href="<?php echo $section['solutionscoco_array_link']; ?>" class="solution-coco-array green-bordered-button learn-more">Learn more</a>
                                    </div>
                                </div>
                            </div>
<?php $i++; } ?>
