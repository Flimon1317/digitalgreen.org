...
<div class="banner-section">
        <div class="banner-img-normal"><img src="<?php echo esc_url(ot_get_option('press_banner_image')); ?>" 
            class="sub-menu-banner w3-image"/></div>
        <div class="banner-text">
            <div class="container text-white">
                <div class="row banner-inner">
                    <span class="banner-square"></span>
                    <h1 class="dg-header-1 banner-title"><?php echo ot_get_option('press_banner_title'); ?></h1>
                    <h4 class="dg-header-3 text-white hidden-xs"><?php echo ot_get_option('press_banner_heading'); ?></h4>
                    <h5 class="dg-header-5 banner-details"> <?php echo ot_get_option('press_banner_desc'); ?></h5>
                </div>
            </div>
        </div>
    </div>
    <div class="mobile-banner-text hidden-lg hidden-md hidden-sm">
        <h5 class="dg-header-5 banner-details">
            <?php echo ot_get_option('press_banner_desc'); ?>
        </h5>
    </div>
        ...
        <div class="container section-header container-sectionH">
            <div class="title-row row">
                <div class="title-header">
                    <h1 class="dg-header-1 main-section-title "><?php echo ot_get_option('press_press_title'); ?>
...
<?php
      if (function_exists('get_option_tree')){
        $press_press = ot_get_option( 'press_press', array() );
        if ( ! empty( $press_press ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $press_press as $section ) {
      ?>
                        ...
                        <div class="gray-boxes">
                            <div class="box-inner-white-border">
                                <div class="gray-boxes-text-content">
                                    <h2 class="card-title"><?php echo $section['press_title']; ?> </h2>
                                    <p class="hidden-sm hidden-md hidden-lg ">
                                        <a href="<?php echo $section['press_link']; ?>" class="forward-redirection-green-link">Learn More <i class="on-hover-arrow-left" aria-hidden="true"></i></a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo $section['press_attach']; ?>" target="_blank" class="forward-redirection-green-link">
                            <div class="hover-card-details hidden-xs">
                                <div class="hover-card-text-content">
                                    <h3 class="dg-header-3 text-white"><?php echo $section['press_area']; ?></h3>
                                    <div class="count-globel-impact-stat text-center">
                                        <h1 class="dg-header-1 forward-redirection-green-link"><?php echo $section['press_value']; ?></h1>
                                        <h4 class=" text-white"><?php echo $section['press_desc']; ?></h4>
                                    </div>
                                   <p>
                                        <a href="<?php echo $section['press_attach']; ?>" target="_blank" class="forward-redirection-green-link">Learn More <i class="on-hover-arrow-left" aria-hidden="true"></i></a>
                                    </p> 
                                </div>
                            </div>
                        </a>
...
?>
 ...
 <?php
      if (function_exists('get_option_tree')){
        $press_solution_values = ot_get_option( 'press_solution_values', array() );
        if ( ! empty( $press_solution_values ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $press_solution_values as $section ) {
            
      ?>

                                <div class="count-global-stat text-center">
                                    <h1 class="dg-header-1"><?php echo $section['press_solution_value']; ?></h1>
                                    <h4 class="dg-header-5"><?php echo $section['press_solution_text']; ?></h4>
                                </div>
<?php } } } ?>
