...
<div class="banner-section">
        <div class="banner-img-normal"><img src="<?php echo get_field('press_kit_banner_image'); ?>" 
            class="sub-menu-banner w3-image"/></div>
        <div class="banner-text">
            <div class="container text-white">
                <div class="row banner-inner">
                    <span class="banner-square"></span>
                    <h1 class="dg-header-1 banner-title"><?php echo get_field('press_kit_banner_title'); ?></h1>
                    <h4 class="dg-header-3 text-white hidden-xs"><?php echo get_field('press_kit_banner_heading'); ?></h4>
                    <h5 class="dg-header-5 banner-details"> <?php echo get_field('press_kit_banner_description'); ?></h5>
                </div>
            </div>
        </div>
    </div>
    <div class="mobile-banner-text hidden-lg hidden-md hidden-sm">
        <h5 class="dg-header-5 banner-details">
            <?php echo get_field('press_kit_banner_description'); ?>
        </h5>
    </div>
        ...
        <div class="container section-header container-sectionH">
            <div class="title-row row">
                <div class="title-header">
                    <h1 class="dg-header-1 main-section-title "><?php echo get_field('press_kit_casestudies_heading'); ?>
 ...
 <?php $i=1;
                                while ( have_rows('press_kit_casestudies') ) 
                                {   
                                    the_row();
                                    ?>
                        ...
                        <div class="gray-boxes">
                            <div class="box-inner-white-border">
                                <div class="gray-boxes-text-content">
                                    <h2 class="card-title"><?php echo get_sub_field('press_kit_casestudies_title'); ?> </h2>
                                    <p class="hidden-sm hidden-md hidden-lg ">
                                        <a href="<?php echo get_sub_field('press_kit_casestudies_file'); ?>" class="forward-redirection-green-link">Learn More <i class="on-hover-arrow-left" aria-hidden="true"></i></a>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo get_sub_field('press_kit_casestudies_file'); ?>" target="_blank" class="forward-redirection-green-link">
                            <div class="hover-card-details hidden-xs">
                                <div class="hover-card-text-content">
                                    <h3 class="dg-header-3 text-white"><?php echo get_sub_field('press_kit_casestudies_place'); ?></h3>
                                    <div class="count-globel-impact-stat text-center">
                                        <h1 class="dg-header-1 forward-redirection-green-link"><?php echo get_sub_field('press_kit_casestudies_value'); ?></h1>
                                        <h4 class=" text-white"><?php echo get_sub_field('press_kit_casestudies_description'); ?></h4>
                                    </div>
                                   <p>
                                        <a href="<?php echo get_sub_field('press_kit_casestudies_file'); ?>" target="_blank" class="forward-redirection-green-link">Learn More <i class="on-hover-arrow-left" aria-hidden="true"></i></a>
                                    </p> 
                                </div>
                            </div>
                        </a>
...
<?php }  ?>
 ...
 <?php $i=1;
                                while ( have_rows('press_kit_featured_values') ) 
                                {   
                                    the_row();
                                    ?>

                                <div class="count-global-stat text-center">
                                    <h1 class="dg-header-1"><?php echo get_sub_field('press_kit_featured_value'); ?></h1>
                                    <h4 class="dg-header-5"><?php echo get_sub_field('press_kit_featured_value_desc'); ?></h4>
                                </div>
<?php }  ?>
                                    ...
                                    <div class="full-col col-sm-7">
                                        <div class="our-solution-wrap">
                                            <div class="our-solution-box">
                                                <h3 class="dg-header-2 sub-section-title on-hover-title-color"><?php echo get_field('press_kit_featured_title'); ?> <i class="grey-arrow-right hidden-xs" aria-hidden="true"></i><span class="half-squre-before-title"></span>
                                                </h3>
                                                <p class="dg-header-5 on-hover-title-color"><?php echo get_field('press_kit_featured_description'); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="full-col col-sm-5 solution-img-wrap hidden-xs">
                                        <div class="our-solution-img">
                                            <img src="<?php echo get_field('press_kit_featured_image'); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$blog_id=get_field('press_kit_featured_blog');
