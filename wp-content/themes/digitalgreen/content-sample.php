...
<div class="page-sub-menu clearfix hidden-xs">
 ...
 <!-- Banner Section -->
      ...
      if (function_exists('get_option_tree')){
        $sample_2d = ot_get_option( 'sample_2d', array() );
        if ( ! empty( $sample_2d ) ) {
          
          $i=1;
          foreach( $sample_2d as $section ) {
      ?>
        <div class="banner-section">
            <div class="banner-img"><img src="<?php echo $section['sample_banner_image']; ?>" class="img-responsive"/></div>
            <div class="banner-text">
                <div class="container text-white">
                    <div class="row banner-inner">
                        <span class="banner-square"></span>
                        <h1 class="dg-header-1 banner-title"><?php echo $section['sample_banner_title']; ?></h1>
                        <h5 class="dg-header-5 banner-details hidden-xs">
                            <?php echo $section['sample_banner_desc']; ?>
                        </h5>
                    </div>
                </div>
            </div>
