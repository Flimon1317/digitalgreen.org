...
include 'header.php'; ?>
                ...
                <div class="container">
                    <div class="country-banner">
                        <div class="row banner-inner">
                            ...
                            <h1 class="dg-header-1 banner-title"><?php echo ot_get_option('ethopia_banner_title'); ?></h1>
                            <h4 class="dg-header-3 text-white hidden-xs"><?php echo ot_get_option('ethopia_banner_heading'); ?></h4>
                            <h5 class="dg-header-5 banner-details hidden-xs"><?php echo ot_get_option('ethopia_banner_desc'); ?>
        ...
        <div class="mobile-banner-text hidden-lg hidden-md hidden-sm">
            <h5 class="dg-header-5 banner-details">
                <?php echo ot_get_option('ethopia_banner_desc'); ?>
            </h5>
        </div>
         <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4 black-box-blocks">
                        <div class="text-center">
                            <span class="black-box-num"><?php echo ot_get_option('ethopia_image_value1'); ?></span>
                            <p class="text-detail"><?php echo ot_get_option('ethopia_image_value1_text'); ?></p>
                        </div>
                    </div>
                    <div class="col-sm-4 black-box-blocks">
                        <div class="text-center">
                            <span class="black-box-num"><?php echo ot_get_option('ethopia_image_value2'); ?></span>
                            <p class="text-detail"><?php echo ot_get_option('ethopia_image_value2_text'); ?></p>
                        </div>
                    </div>
                    <div class="col-sm-4 black-box-blocks">
                        <div class="text-center">
                            <span class="black-box-num"><?php echo ot_get_option('ethopia_image_value3'); ?></span>
                            <p class="text-detail"><?php echo ot_get_option('ethopia_image_value3_text'); ?></p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      if (function_exists('get_option_tree')){
        $ethopia_approach = ot_get_option( 'ethopia_approach', array() );
        if ( ! empty( $ethopia_approach ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $ethopia_approach as $section ) {
      ?>
                  <div class="slider-with-tab <?php if($i==1) echo 'active-tab'; ?>" data-index="<?php echo $i; ?>"><h1 class="dg-header-1"><?php echo $section['ethopia_approach_title']; ?></h1>
                    <p><?php echo $section['ethopia_approach_short_desc']; ?></p>
                  </div>
      ...
      ?>
                        ...
                        <div class="slider-with-tab hidden-lg hidden-md" data-index="<?php echo $i; ?>"><h1 class="dg-header-2"><?php echo $section['ethopia_approach_title']; ?></h1>
                            <p><?php echo $section['ethopia_approach_short_desc']; ?></p>
                        </div>
                                    ...
                                    <div class="row img-details">
                                        <div class="single-img">
                                            <div class="side-gray-border">
                                                <h3 class="dg-header-2 sub-section-title"><?php echo $section['ethopia_approach_heading']; ?>
                                                    <span class="half-squre-before-title"></span>
                                                </h3>
                                                <div class="single-img-content">
                                                    <p class="dg-header-5 text-details"><?php echo $section['ethopia_approach_description']; ?>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
...
<?php
          ...
          $i=1;
          foreach( $ethopia_quote_array as $section ) {
      ?>
                        ...
                        <div class="testimonials-details">
                            ...
                            <p class="dg-header-5 text-details">- <?php echo $section['ethopia_quote_by']; ?></p>
                            <a href="<?php echo $section['ethopia_quote_link']; ?>" class="green-bordered-button learn-more">Learn More</a>
                        </div>
<?php }  ?>
