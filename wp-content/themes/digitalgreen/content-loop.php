            ...
            <div class="banner-text">
                <div class="container text-white">
                    <div class="loop row banner-inner">
                        ...
                        <h1 class="dg-header-1 banner-title"><?php echo ot_get_option('loop_banner_title'); ?></h1>
                        <h4 class="dg-header-3 text-white header-img-text-single-line hidden-xs"><?php echo ot_get_option('loop_banner_sub_title'); ?></h4>
                        <h5 class="dg-header-5 banner-details hidden-xs">
                           <?php echo ot_get_option('loop_banner_desc'); ?>
                        </h5>
                    </div>
                </div>
            </div>
...
<?php
      if (function_exists('get_option_tree')){
        $loop_approach = ot_get_option( 'loop_approach', array() );
        if ( ! empty( $loop_approach ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $loop_approach as $section ) {
      ?>
                
                  <div class="slider-with-tab <?php if($i==1) echo 'active-tab'; ?>" data-index="<?php echo $i; ?>"><h1 class="dg-header-1"><?php echo $section['loop_approach_title']; ?></h1>
                    <p><?php echo $section['loop_approach_short_desc']; ?></p>
                  </div>
                  <?php $i++; } } } ?>
      ...
      ?>
                        ...
                        <div class="slider-with-tab hidden-lg hidden-md" data-index="<?php echo $i; ?>"><h1 class="dg-header-2"><?php echo $section['loop_approach_title']; ?></h1>
                            <p><?php echo $section['loop_approach_short_desc']; ?></p>
                        </div>
                                    ...
                                    <div class="row img-details">
                                        <div class="single-img">
                                            <div class="side-gray-border">
                                                <h3 class="dg-header-2 sub-section-title"><?php echo $section['loop_approach_heading']; ?>
                                                    <span class="half-squre-before-title"></span>
                                                </h3>
                                                <div class="single-img-content">
                                                    <p class="dg-header-5 text-details"><?php echo $section['loop_approach_description']; ?>
                                                </p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="col-sm-6 col-sm-pull-6 coco-mobile-content">
                                    <div class="what-coco-content">
                                        <h3 class="dg-header-2 sub-section-title">
                                            <?php echo ot_get_option('loop_what_title'); ?>
                                            <span class="half-squre-before-title"></span>
                                        </h3>
                            ...
                            <div class="clearfix coco-about-blocks">
                                ...
                                <div class="col-sm-5 col-sm-offset-1 coco-mobile-content">
                                    <div class="single-mobile-text-content">
                                        <h3 class="dg-header-2 sub-section-title">
                                            <?php echo ot_get_option('loop_how_title'); ?>
                                            <span class="half-squre-before-title"></span>
                                        </h3>
            ...
            <div class="app-screenshots big-arrow-slider">
                <div class="custom-class-slideshow text-center">
                    <div class="container"><h1 class="dg-header-2 mobile-slider-main-title"><?php echo ot_get_option('loop_screenshots_title'); ?></h1></div>
                    <div id="carousel-mobile-img" class="clearfix">
                    <?php
      if (function_exists('get_option_tree')){
        $loop_screenshots = ot_get_option( 'loop_screenshots', array() );
        if ( ! empty( $loop_screenshots ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $loop_screenshots as $section ) {
      ?>
                        <div class="slide-item">
                             <img src="<?php echo $section['loop_screenshot_image']; ?>" alt="slide1">
                        </div> 
                        <?php $i++; } } } ?>
...
<?php
      if (function_exists('get_option_tree')){ 
    $loop_solutions_array = ot_get_option( 'loop_solutions_array', array() );
        if ( ! empty( $loop_solutions_array ) ) {
?>
...
<?php 
          ...
          /* print_r($home_banner); */
          $i=1;
          foreach( $loop_solutions_array as $section ) {
                        ...
                        <div class="col-md-3 work-inner-block">
                                ...
                                <div class="col-md-7">
                                    <div class="our-solution-wrap">
                                        <div class="our-solution-box">
                                            <h3 class="dg-header-2 sub-section-title on-hover-title-color"><?php echo ot_get_option('loop_solution_title'); ?><i class="grey-arrow-right hidden-xs" aria-hidden="true"></i><span class="half-squre-before-title"></span>
                                            </h3>
                                            <p class="dg-header-5 on-hover-title-color"><?php echo ot_get_option('loop_solution_desc'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="custom-class-slideshow stats-slider-wrap">
                                <div class="stats-values stat-slider">
                                   <?php
      if (function_exists('get_option_tree')){
        $loop_solution_values = ot_get_option( 'loop_solution_values', array() );
        if ( ! empty( $loop_solution_values ) ) {
          /* print_r($home_banner); */
          $i=1;
          foreach( $loop_solution_values as $section ) {
            
      ?>

                                    <div class="count-global-stat text-center">
                                        <h1 class="dg-header-1"><?php echo $section['loop_solution_value']; ?></h1>
                                        <h4 class="dg-header-5"><?php echo $section['loop_solution_text']; ?></h4>
                                    </div>
<?php } } } ?>
                                    ...
                                    <div class="row full-row">
                                        ...
                                        <div class="col-sm-5 full-col solution-img-wrap">
                                            <div class="our-solution-img">
                                                <img src="<?php echo ot_get_option('loop_solution_image'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$blog_id=ot_get_option('loop_solution_blog');
